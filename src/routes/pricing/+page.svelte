<script lang="ts">
	...
	let activeTab = $state<'packages' | 'items' | 'movements'>('items');
	...
	const MAIN = [
		...
		{ id: 'tents', label: 'Magazyn', href: '/pricing', active: true }
	];
...
<svelte:head>
	<title>Cennik + Magazyn · Wolny Namiot panel</title>
</svelte:head>
